...
It cannot place orders, close positions, cancel orders, modify MT5 live presets, write MT5 `OrderRequest`, receive Telegram trading commands, or add non-FX instruments.
...
This refreshes local FX evidence and reports only. It does not write MT5 orders.
